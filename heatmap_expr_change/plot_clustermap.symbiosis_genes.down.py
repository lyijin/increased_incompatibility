...
for strain in ['CC7', 'SSB01', 'H2']:
    ...
    temp = temp[temp.index.isin(guoxin_down)]
...
# get row colours
rowcolors = data.index.map(lambda x: '#3288bd')
...
output_filename = 'clustermap.symbiosis_genes.down.pdf'
fig.savefig(output_filename, bbox_inches='tight')

# also save the values of the heatmap in a plain text file
cg.data2d.to_csv('clustermap.symbiosis_genes.down.tsv', sep='\t')
